...
change() {
    ...
    test -f common/Makefile && sed -i "s/EXTRAVERSION =/EXTRAVERSION = -Fleshygrape/g" common/Makefile
    test -f Makefile && sed -i "s/EXTRAVERSION =/EXTRAVERSION = -Fleshygrape/g" Makefile
